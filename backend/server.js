...
process // process object (globally availabe)
  .on(
    // this method is used to attach event handlers to the events
    "uncaughtException",
    (err) => {
...
dotenv.config(
  // this method loads .env file contents into process.env (process object env property which we will use in our application because process is globally availabe)
  {
